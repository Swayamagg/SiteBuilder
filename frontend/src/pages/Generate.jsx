      ...
      <div className='sticky top-0 z-40 backdrop-blur-xl bg-black/50 border-b border-white/10'>
            <div className='max-w-7xl mx-auto px-6 h-16 flex items-center justify-between'>
              <div className='flex items-center gap-4'>
                ...
                <h1 className='text-lg font-semibold'>Site<span className='text-zinc-500'>Builder</span></h1>
              </div>
        ...
        <div className='max-w-6xl mx-auto px-6 py-16'>
          <motion.div initial={{opacity:0,y:30}} animate={{opacity:1,y:0}} className='text-center mb-16'>
              <h1 className='text-4xl md:text-5xl font-bold mb-5 leading-tight'>
               ...
               <p className='text-zinc-400 max-w-2xl mx-auto'>This process may take several minutes.SiteBuilder focueses on quality,not on shortcuts.</p>
          </motion.div>
          <div className='mb-14'>
          ...
          <div className='flex justify-center'>
            <motion.button whileHover={{scale:1.05}} whileTap={{scale:0.96}} onClick={handleGenerate} className='px-14 py-4 rounded-2xl font-semibold text-lg bg-white text-black'>
             Generate Website
            </motion.button>
          </div>
        </div>
