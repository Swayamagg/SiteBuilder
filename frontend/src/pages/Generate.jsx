        ...
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-lg font-semibold">
              Site<span className="text-zinc-500">Builder</span>
            </h1>
          </div>
          <button
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        >
          ...
          <p className="text-zinc-400 max-w-2xl mx-auto">
            This process may take several minutes.SiteBuilder focueses on
            quality,not on shortcuts.
          </p>
        </motion.div>
        <div className="mb-14">
        ...
        {loading && (
          <motion.div initial={{opacity:0}} animate={{opacity:1}} className="max-w-xl mx-auto mt-12">
            <div className="flex justify-between tex-xs mb-2 text-zinc-400">
            ...
            <div className="text-center text-xs mt-4 text-zinc-400">Estimated time remaining:{" "}<span className="text-white font-medium">~8-12 minutes</span></div>
          </motion.div>
