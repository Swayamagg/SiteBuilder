  ...
  return (
    <AnimatePresence>
      {open && (
        ...
        >
          <motion.div
            className="relative w-full max-w-md p-[1px] rounded-3xl bg-gradient-to-br from bg-purple-500/40 via-blue-500/30 to-transparent"
            initial={{ scale: 0.88, opacity: 0, y: 60 }}
            animate={{ scale: 1, opacity: 1, y: 0 }}
            exit={{ scale: 0.89, opacity: 0, y: 40 }}
